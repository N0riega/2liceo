...
let Johan = new Personaje(200,100,0,50)
Johan.dibujarse();
let Luis = new Personaje(200,300,45,30)
Luis.dibujarse();
let Pablo = new Personaje(200,100,-45,90)
Johan.dibujarse();
let Josue = new Personaje(200,300,180,70)
Luis.dibujarse();

let contenedor =  document.querySelector("#contenedor")
contenedor.innerHTML = "johan luis pablo y josue";